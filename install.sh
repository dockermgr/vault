...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410011655-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 01, 2024 16:55 EDT
# @@File             :  install.sh
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="vault"
export VERSION="202410011655-git"
...
DOCKER_REGISTRY_REPO_NAME="vault"
...
CONTAINER_SECRET_KEY_NAME="ADMIN_TOKEN"
...
#DUO_IKEY=
#DUO_SKEY=
SMTP_HOST=${CONTAINER_EMAIL_RELAY_SERVER:-$SET_DOCKER_IP}
SMTP_FROM=${CONTAINER_EMAIL_USER:-no-reply@}${CONTAINER_EMAIL_DOMAIN:-$CONTAINER_HOSTNAME}
SMTP_PORT=${CONTAINER_EMAIL_RELAY_PORT:-587}
